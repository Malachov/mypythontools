...
def plot(
    ...
    save_path: None | Path | str = None,
    return_div: bool = False,
    show: bool = True,
) -> None | str:
    """Plots the data. Plotly or matplotlib can be used. It is possible to highlite two columns with different
    ...
    Args:
        ...
        save_path (None | Path | str, optional): Whether save the plot.  If False or "", do not save,
    ...
    Examples:
        ...
        ... )
        >>> helpers.plots.plot(df, grey_area=["0", "1"], show=False)
    ...
    if save_path == "DESKTOP":
        save_path = paths.get_desktop_path() / "plot.html"
